    ...
    collapseData: [
        {
          ...
          title: "급여 정산",//"내 결제함",
          className: "",
          ref: "/account/getAccountInfo.src1",
          onClick: "",
        },
        {
          id: "approval_form",
          title: "수익관리",//"결재양식",
          className: "",
          ref: "/account/getProfitList.src1",
          onClick: "",
        },
        {
          id: "approval_send",
          title: "지출관리",//"결재신청",
          className: "",
          ref: "/account/getExpenseList.src1",
          onClick: "",
        },
        {
        id: "approval_wb",
        title: "손익조회",//"휴지통",
        className: "",
        ref: "/account/getBalanceList.src1",
        onClick: "",
        },
        {
        id: "approval_wb",
    ...
    collapseData: [
      {
        ...
        title: "신청",//"파견사원",
        className: "",
        ref: "/approval/getApprovalFormList.src1",
        onClick: "",
      },
      {
        id: "admin",
        title: "발신함",//"관리자",
        className: "",
        ref: "/approval/getSendApproval.src1",
        onClick: "",
        collapsed: false,
      },
      {
        ...
        title: "수신함",//"부서일정",
        className: "",
        ref: "/approval/getReceiveApproval.src1",
        onClick: "",
        collapsed: false,
