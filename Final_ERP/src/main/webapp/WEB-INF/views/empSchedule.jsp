<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String emp_name = (String)session.getAttribute("login_name");
...
<head>
    ...
    <link rel="stylesheet" href="<%=path.toString() %>common/vendor/css/bootstrap.min2.css?after=4">
...
<script src="<%=path.toString() %>common/scripts.js"></script>
    ...
    <script src="<%=path.toString() %>common/js/addEvent.js?ver=8"></script>
    <script src="<%=path.toString() %>common/js/editEvent.js?ver=14"></script>
